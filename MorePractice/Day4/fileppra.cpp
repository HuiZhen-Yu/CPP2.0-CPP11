...
int main(int argc, char const *argv[])
{
    ...
    fstream ioFile;
/*     ioFile.open("d:/Source/github/CPP2.0-CPP11/MorePractice/Day4/per.dat", ios::out | ios::app | ios::binary);
    cout << "---------建立学生档案信息----------\n";
    do
    {
        cout << "请输入姓名：";
    ...
    ioFile.open("d:/Source/github/CPP2.0-CPP11/MorePractice/Day4/per.dat", ios::in | ios::binary);
    Person p;
